            ...
            <section class="card">
              ...
              <?php
                ...
                try {
                  ...
                  $sql_select = "select * from work_description;";
                  $result = $conn->query($sql_select);

                  $sajid_description = $result->fetch_assoc()['description'];
                  $siumi_description = $result->fetch_assoc()['description'];
                  $sandeep_description = $result->fetch_assoc()['description'];
                  $antonio_description = $result->fetch_assoc()['description'];
                  $tony_description = $result->fetch_assoc()['description'];  

                } catch (Exception $e) {
                  $sajid_description = "Team Leader, Application Page Developer, & EOI Processor...";
                  $siumi_description = "Home & Group Details Manager";
                  $sandeep_description = "Job Apps, Position Descriptions";
                  $antonio_description = "Enhancements, Styling, & Admin Page Manager";
                  $tony_description = "Styling, Quality, & Consistency Insurance";
                }
              ?>
              <dl>
                <dt>Sajid Hasan</dt>
                <dd><?php echo($sajid_description);?> - "Ship small, learn fast." (Fav. language: <span lang="en">TypeScript</span>)</dd>
                <br>
                <dt>Kammantrige Siumi Sathsarani</dt>
                <dd><?php echo($siumi_description);?> - "Design first, code clean." (Fav. language: <span lang="en">HTML</span> - Sinhala: <span lang="en"> </span>)</dd>
                <br>
                <dt>Sandeep Y. D. S. Anthonydura</dt>
                <dd><?php echo($sandeep_description);?> - "Clarity beats cleverness." (First language: <span lang="en"> Sinhala </span>)</dd>
                <br>
                <dt>Antonio Prince</dt>
                <dd><?php echo($antonio_description);?> — “Details make the experience.” (Fav. language: <span lang="en">CSS</span>)</dd>
                <br>
                <dt>Trong Tin Vo</dt>
                <dd><?php echo($tony_description);?> — “It'll work if you bang your head at it enough." (Fav. language: 
